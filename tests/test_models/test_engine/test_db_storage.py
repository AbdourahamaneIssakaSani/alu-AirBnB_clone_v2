...
class TestDBStorage(unittest.TestCase):
    ...
    def test_user(self):
        ...
        user.save()
        self.assertTrue(user.id in models.storage.all())
    ...
    def test_city(self):
        ...
        city.save()
        self.assertTrue(city.id in models.storage.all())
    ...
    def test_state(self):
        ...
        state.save()
        self.assertTrue(state.id in models.storage.all())
    ...
    def test_place(self):
        ...
        place.save()
        self.assertTrue(place.id in models.storage.all())
    ...
    def test_amenity(self):
        ...
        amenity.save()
        self.assertTrue(amenity.id in models.storage.all())
    ...
    def test_review(self):
        ...
        review.save()
        self.assertTrue(review.id in models.storage.all())
